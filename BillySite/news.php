...
<html>
    ...
    function newsFunc()
    {
        ...
        for($i = 0; $i < $count; $i++){
            ...
            $newsDiv = "<div class=\"row\"style=\"color:white; background-color:".$color."; margin-top:5px; font-size: 2em; width:100%;\"><div class=\"col-md-6 col-md-offset-3\">";
            while ($line = fgets($f)) {
    ...
    ?>
        ...
        <?php include 'includes/header.html'?>
            <div class="row" style="background-color: #80B8EA; width:100%; color:white; padding-left: 5%; height:100%;">
            <div class="container">
